...
callthing * callthing::CreateKeyboardEvent(const wxString& function, int key)
{
    ...
    callevent->kind = EVENTTYPE::EVENTTYPE_Keyboard;
...
{
    callthing * callevent = new callthing;
    callevent->kind = EVENTTYPE::EVENTTYPE_Mouse;
    callevent->func = function;
    callevent->arg1 = x;
    callevent->arg2 = y;
...
{
    callthing * callevent = new callthing;
    callevent->kind = EVENTTYPE::EVENTTYPE_YieldFunction;
    callevent->func = function;
...
{
    callthing * callevent = new callthing;
    callevent->kind = EVENTTYPE::EVENTTYPE_NoYieldFunction;
    callevent->func = function;
...
{
    callthing * callevent = new callthing;
    callevent->kind = EVENTTYPE::EVENTTYPE_NetworkReceiveReady;
...
callthing::~callthing()
{
    switch (kind)
    {
    case EVENTTYPE::EVENTTYPE_NetworkReceiveReady:
        //free(func);
        //free(networkpacket);
        break;

    case EVENTTYPE::EVENTTYPE_Unknown:
    case EVENTTYPE::EVENTTYPE_Mouse:
    case EVENTTYPE::EVENTTYPE_Keyboard:
    case EVENTTYPE::EVENTTYPE_YieldFunction:
    case EVENTTYPE::EVENTTYPE_NoYieldFunction:
