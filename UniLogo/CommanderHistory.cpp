...
CCommanderHistory::CCommanderHistory(
    ...
    wxWindowID      Id
        ...
        wxDefaultPosition,
        wxDefaultSize,
        wxRE_READONLY | wxWANTS_CHARS | wxBORDER_SUNKEN)
{
...
void CCommanderHistory::OnContextMenu(wxContextMenuEvent& Event)
{
    ...
    static const MENUITEM contextMenuItems[] = {
        ...
        {GetResourceString(L"LOCALIZED_POPUP_REMOVELINES"), (int)CMIDS::ID_REMOVELINES},
...
BEGIN_EVENT_TABLE(CCommanderHistory, wxRichTextCtrl)
    ...
    EVT_MENU((int)CMIDS::ID_REMOVELINES,      CCommanderHistory::OnRemoveSelectedLines)
    EVT_UPDATE_UI((int)CMIDS::ID_REMOVELINES, CCommanderHistory::OnUpdateRemoveSelectedLines)
END_EVENT_TABLE()
