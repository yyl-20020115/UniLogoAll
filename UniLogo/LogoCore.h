#ifndef __LOGOCORE_H__
#define __LOGOCORE_H__
...
enum class ERR_TYPES : int
{
    ...
    // UniLogo-specific error codes start at 1000
    WINDOW_GENERAL                = 1000,
