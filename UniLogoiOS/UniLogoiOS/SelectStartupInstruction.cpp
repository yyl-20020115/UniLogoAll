      ...
      m_ProcedureList(NULL)
{
    ...
    // Add the text input
    m_InstructionText = new wxTextCtrl(this, (int)CKID::ID_INSTRUCTIONTEXT);
    topLevelSizer->Add(
        m_InstructionText,
        0,
        wxTOP | wxLEFT | wxRIGHT | wxEXPAND,
...
BEGIN_EVENT_TABLE(CSelectStartupInstructionDialog, wxDialog)
    EVT_TEXT((int)CKID::ID_INSTRUCTIONTEXT,   CSelectStartupInstructionDialog::OnInstructionTextChange)
    EVT_LISTBOX((int)CKID::ID_PROCEDURELIST,  CSelectStartupInstructionDialog::OnProcedureSelect)
