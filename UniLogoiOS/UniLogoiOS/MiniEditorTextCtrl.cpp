    ...
    ) : CLogoCodeCtrl(Parent, Id)
{
    ...
    acceleratorEntries[6].Set(wxACCEL_CTRL, ']', (int)CKID::ID_FINDMATCHINGPAREN);
    ...
    acceleratorEntries[8].Set(wxACCEL_CTRL, WXK_SPACE,(int)CKID::ID_AUTOCOMPLETE);
...
BEGIN_EVENT_TABLE(CMiniEditorTextCtrl, CLogoCodeCtrl)
    ...
    EVT_MENU((int)CKID::ID_FINDMATCHINGPAREN,   CMiniEditorTextCtrl::OnFindMatchingParen)
    EVT_MENU((int)CKID::ID_SELECTMATCHINGPAREN, CMiniEditorTextCtrl::OnSelectMatchingParen)
    EVT_MENU((int)CKID::ID_AUTOCOMPLETE,        CMiniEditorTextCtrl::OnAutoComplete)
END_EVENT_TABLE()
