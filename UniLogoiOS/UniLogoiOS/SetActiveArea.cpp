...
enum class ID_SETACTIVEAREA :int
{
      ...
      m_PixelsPerInch(NULL)
{
    ...
    m_PixelsPerInch = new CSmallIntegerCtrl(
        this,
        (int)ID_SETACTIVEAREA::ID_PIXELSPERINCH,
        PixelsPerInch);
    pixelsPerInchRow->Add(
        m_PixelsPerInch,
        0,
...
BEGIN_EVENT_TABLE(CSetActiveArea, wxDialog)
    EVT_BUTTON((int)ID_SETACTIVEAREA::ID_RESET,     CSetActiveArea::OnReset)
END_EVENT_TABLE()
