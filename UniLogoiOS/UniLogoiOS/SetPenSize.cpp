      ...
      m_ExternalReference(ExternalReference)
{
    ...
    static const struct {
        ...
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE1, 1},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE2, 2},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE3, 3},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE4, 4},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE5, 6},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE6, 8},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE7, 16},
        {(int)ID_SETPENSIZE::ID_SETPENSIZE_SIZE8, 32},
    };
    ...
    m_ThicknessSlider = new wxSlider(
        this,
        (int)ID_SETPENSIZE::ID_SETPENSIZE_SLIDER,
        m_PenWidth, 
        1,
        32,
        wxDefaultPosition,
    ...
    wxButton *apply = new wxButton(
        this, 
        (int)ID_SETPENSIZE::ID_SETPENSIZE_APPLY,
...
{    // Run "SETPENSIZE <PENSIZE>"
    RunLogoInstructionFromGui(wxString::Format(L"%s %d", ArgumentUtils::NormalizeCaseForDisplay(GetResourceString(L"LOCALIZED_ALTERNATE_SETPENSIZE")), m_PenWidth));
}
...
BEGIN_EVENT_TABLE(CSetPenSize, wxDialog)
    ...
    EVT_BUTTON((int)ID_SETPENSIZE::ID_SETPENSIZE_APPLY,  CSetPenSize::OnApplyButton)
    EVT_SLIDER((int)ID_SETPENSIZE::ID_SETPENSIZE_SLIDER, CSetPenSize::OnSliderUpdated)
END_EVENT_TABLE()
